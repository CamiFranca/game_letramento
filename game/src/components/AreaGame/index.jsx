...
export const AreaGame = () => {
    ...
    const [isGameStarted, setIsGameStarted] = useState(false); // Controle do estado do jogo
    ...
    const checkGameResult = () => {
        // Verifica se há ícones nas cestas
        ...
        if (!hasIcons) {
            ...
            // Verifica se todos os ícones estão nas cestas corretas
            let isCorrect = true;
    ...
    const startGame = () => {
        ...
        setTimer(40);
        setIsGameStarted(true); // Inicia o jogo
        createListIcons();
    };
